...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <!-- Top Navigation Bar -->
    <nav class="bg-emrald-800 text-white shadow-md">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white shadow-md rounded-lg border border-gray-200 p-6 h-fit">
                ...
                <form action="{{ route('tickets.store') }}" method="POST" class="space-y-4">
                    ...
                    <button type="submit" class="w-full bg-emrald-900 text-white hover:bg-emrald-800 font-semibold text-sm py-2.5 px-4 rounded transition-colors shadow shadow-blue-900/20">
            ...
            <div class="lg:grid-cols-1 lg:col-span-2 bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
                <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <span class="px-2.5 py-0.5 text-xs font-semibold bg-emrald-100 text-blue-800 rounded-full">Live Monitor</span>
                </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <form action="{{ route('tickets.updateStatus', $ticket->id) }}" method="POST" class="inline-block">
                                            ...
                                            <select name="status" onchange="this.form.submit()"
                                                ...
                                                @if($ticket->status === 'Open') bg-emrald-100 text-blue-700 border-blue-200

        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white shadow-md rounded-lg border border-gray-200 p-6 h-fit">
                ...
                <form action="{{ route('tickets.store') }}" method="POST" class="space-y-4">
                    ...
                    <button type="submit" class="w-full bg-emrald-900 text-white hover:bg-blue-800 font-semibold text-sm py-2.5 px-4 rounded transition-colors shadow shadow-blue-900/20">
